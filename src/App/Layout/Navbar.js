  ...
  return (
    <>
      <div className="head-nav p-4 md:p-7 grid grid-cols-2 gap-20">
        <div className="brand col-span-2 md:col-span-1 flex" >
          <div className="grow flex flex-row">
            <img src={brand} alt="swastik bose brand" />
            <p className='font-11 subquote l-h-1 pt-14 md:pt-12 pl-2.5 f-color-9'>thinking <br />abstract for new creation</p>
          </div>
          <div className="grow-0 flex flex-col menus">
            {/* <RiApps2Fill size={30} className='f-color-1'/>
            <p className='font-11 subquote l-h-1 pt-1 md:pt-0 f-color-9'>Menus</p> */}       
